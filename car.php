...
Category<br>
<input type="text" class="form-control" name="cat" required><br>
Lessons<br>
<input type="text" class="form-control" name="lesson" required><br>
<input type = "submit" class="btn btn-custom" name = "submit" value = "Add"> 
</form>
<?php	
}
?>
