                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            <a href="change_profile.php" class="nav-item nav-link active">Home</a>
                            <a href="logs.php" class="nav-item nav-link">Logs</a>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="car.php" class="dropdown-item">Add Car Lesson type</a>
                                    <a href="car_type.php" class="dropdown-item">Add Car Lessons Details</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Students</a>
                                <div class="dropdown-menu">
                                    <a href="viewstudents.php" class="dropdown-item">View Registered Student</a><br>
                                    <a href="updatestudent.php" class="dropdown-item">Update Student Records</a><br> 
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Employee</a>
                                <div class="dropdown-menu">
                                    <a href="register.php" class="dropdown-item">Add New Employee</a>
                                    <a href="reg_users.php" class="dropdown-item">View Registered Employee</a>
                                    <a href="updatepage.php" class="dropdown-item">Update Employee Records</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Payment</a>
                                <div class="dropdown-menu">
                                    <a href="payment.php" class="dropdown-item">process payment</a><br> 
                                    <a href="view_payment.php" class="dropdown-item">View payment</a><br> 
                                </div>
                            </div>
                        ...
                        <div class="ml-auto">
                            <a href="student.php" class="btn btn-custom">Register New Student</a>
                        </div>
                    </div>
                </nav>
            </div>
                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            ...
                            <a class="btn btn-custom" href="student.php">Online Addmission</a>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="carousel-img">
                    ...
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="img/carousel-31.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                        <h3>Learn Drive With Us</h3><br>
                            <a class="btn btn-custom" href="student.php">Online Addmission</a>
