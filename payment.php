...
transact id<br>
<input type="text" name="transactid" class="form-control" required maxlength="5"><br>
paid for<br>
<input type="text" name="paid_for" class="form-control" required maxlength="5"><br>
paid by<br>
<input type="text" name="paid_by" class="form-control" required maxlength="5"><br>
amount<br>
<input type="text" name="amount" class="form-control" required maxlength="5"><br><br>
<input type = "submit" name = "submit" class="btn btn-custom" value = "process transaction"> 
</form>
<?php	
}
?>
