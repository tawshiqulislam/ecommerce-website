...
email<br>
<input type="text" name="email" class="form-control" value = "<?php echo $row['email'];?>" required><br>
phone<br>
<input type="text" name="phone" class="form-control" required maxlength="12" value="<?php echo $row['phone'];?>""><br>
town<br>
<input type="text" name="town" class="form-control" value = "<?php echo $row['town'];?>" required><br>
