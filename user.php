                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="us_logs.php" class="nav-item nav-link">Logs</a>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="us_viewstudents.php" class="dropdown-item">View Registered Student</a><br>
                                    <a href="us_updatestudent.php" class="dropdown-item">Update Student Records</a><br> 
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Employee</a>
                                <div class="dropdown-menu">
                                    <a href="us_reg_users.php" class="dropdown-item">View Registered Employee</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Payment</a>
                                <div class="dropdown-menu">
                                    <a href="us_payment.php" class="dropdown-item">Process Payment</a><br> 
                                    <a href="us_view_payment.php" class="dropdown-item">View Payment</a><br> 
                                </div>
                            </div>
                        ...
                        <div class="ml-auto">
                            <a href="us_student.php" class="btn btn-custom">Register New Student</a>
                        </div>
                    </div>
                </nav>
            </div>
                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            ...
                            <a class="btn btn-custom" href="us_student.php">Online Addmission</a>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="carousel-img">
