                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="us1_viewstudents.php" class="dropdown-item">View Registered Student</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Employee</a>
                                <div class="dropdown-menu">
                                    <a href="us1_reg_users.php" class="dropdown-item">View Registered Employee</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Payment</a>
                                <div class="dropdown-menu">
                                    <a href="us1_view_payment.php" class="dropdown-item">View Payment</a>
                                </div>
                            </div>
                        ...
                        <div class="ml-auto">
                            <a href="gds.php" class="btn btn-custom">Register New Student</a>
                        </div>
                    </div>
                </nav>
            </div>
