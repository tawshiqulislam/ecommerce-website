            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
						...
						<a href="index.php" class="nav-item nav-link active">Back</a>
                            </div>
...
<input type = "submit"  class="btn btn-custom" name = "submit" value = "log in"> 
</form>
<?php
}
?>
